        ...
        <div class="col-12 col-md-7 col-lg-5">
            ...
            <div class="main-card p-4 p-sm-5 bg-white rounded-4 shadow">
                ...
                <div class="mb-3 d-flex justify-content-between align-items-center">
                    <a href="Index.php" class="back-btn text-decoration-none fw-semibold">← MENU</a>
                    <a href="BRegistration.php" class="back-btn text-decoration-none fw-semibold">REGISTER →</a>
                </div>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                    ...
                    <div class="text-center">
                        <button type="submit" name="submit_login" class="btn btn-lg feu-btn px-5 rounded-pill fw-semibold shadow-sm w-100">Login</button>
                    </div>
                </form>
